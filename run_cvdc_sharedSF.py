...
from method.CVDC_sharedSF import SF_CVDC as Network
...
TRAIN_NAME = "CVDC_sharedSF_{}_{:02d}_convoy_{}g{}a_{}g{}a_m{}".format(
    args.machine,
    args.train_number,
    args.nbg,
    args.nba,
...
TRAIN_TAG = "Central value decentralized control(learnability) with sharedSF, " + TRAIN_NAME
