...
from network.CVDC_model_ import Central
from network.CVDC_model_ import Decentral as Decentral1
from network.CVDC_model_v3 import Decentral as Decentral3
from network.CVDC_model_v4 import Decentral as  Decentral4
from network.CVDC_model_ import train
from network.CVDC_model_ import loss_central
from network.CVDC_model_ import loss_ppo
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ppo_config = {
                ...
                'psi_beta': tf.constant(psi_beta, dtype=tf.float32),
                'reward_beta': tf.constant(reward_beta, dtype=tf.float32),
                'decoder_beta': tf.constant(decoder_beta, dtype=tf.float32),
                'critic_beta': tf.constant(critic_beta, dtype=tf.float32),
                'q_beta': tf.constant(q_beta, dtype=tf.float32),
                'learnability_beta': tf.constant(learnability_beta, dtype=tf.float32),
                }
