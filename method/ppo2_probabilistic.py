...
from network.model_V2 import V2_PPO_Probabilistic
...
class PPO:
        ...
        **kwargs
        ...
        with self.sess.as_default(), self.sess.graph.as_default():
            with tf.variable_scope(scope):
                ...
                # Build Network
                model = V2_PPO_Probabilistic(action_size);  self.model = model
    ...
    def run_network(self, states, return_action=True):
        ...
        if return_action:
            ...
            return actions, critics, logits, uncertainty
        else:
            return a_probs, critics, logits, uncertainty
