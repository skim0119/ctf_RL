...
from network.PG import V4PG, train, get_gradient, loss
    ...
    def __init__(
        ...
        **kwargs
        ...
        for i in range(self.num_agent_type):
            # Model defnition
            model = V4PG(input_shape[1:], action_size=action_size)
