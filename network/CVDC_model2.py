...
from network.model_V4_30 import V4, V4INV, V4_lstm
from network.model_V4_30 import V4Decentral, V4INVDecentral, V4Decentral_lstm
...
@tf.function
def loss_ppo_lstm(model, state, old_log_logit, action, old_value, td_target, advantage, td_target_c, rewards, next_state,
        eps, entropy_beta, q_beta, psi_beta, decoder_beta, critic_beta, learnability_beta,):
    num_sample = state.shape[0]
