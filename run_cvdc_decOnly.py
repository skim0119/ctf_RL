...
from method.CVDC_decOnly import SF_CVDC as Network
...
TRAIN_NAME = "CVDC_decOnly_{}_{:02d}_convoy_{}g{}a_{}g{}a_m{}".format(
    args.machine,
    args.train_number,
    args.nbg,
    args.nba,
...
TRAIN_TAG = "decentralized control(learnability), " + TRAIN_NAME
